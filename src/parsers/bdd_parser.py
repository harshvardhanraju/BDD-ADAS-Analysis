...
class BDDParser:
    ...
    def parse_bdd_annotation(self, annotation_data: Dict) -> ImageAnnotation:
        ...
        try:
            ...
            self.stats['parsing_errors'].append({
                'annotation': annotation_data.get('name', 'unknown'),
                'error': str(e)
            })
            raise
    ...
    def validate_image_annotation_pairs(self, annotations: Dict[str, List[ImageAnnotation]]) -> Dict[str, Any]:
                ...
                if image_path.exists():
                    ...
                    try:
                        with Image.open(image_path) as img:
                            ...
                            validation_results['image_statistics'][split][annotation.name] = {
                                'width': width,
                                'height': height,
                                'mode': mode,
    ...
    def export_parsed_data(self, annotations: Dict[str, List[ImageAnnotation]], 
    ...
    def get_parsing_summary(self) -> Dict[str, Any]:
        ...
        return {
            'dataset_statistics': {
                ...
                'average_objects_per_image': self.stats['total_objects'] / max(self.stats['total_images'], 1)
            },
